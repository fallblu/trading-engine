let version = "7"
let previous_version = "6"
let legacy_journal_version = "3"

let supported_versions =
  [ version; previous_version; "5"; "4"; legacy_journal_version ]

let is_supported version = List.mem version supported_versions
let strategy_protocol_version = "5"
let previous_strategy_protocol_version = "4"
  ...
  `Assoc
    [
      ...
      ( "strategy_protocol_versions",
        strings
          [ strategy_protocol_version; previous_strategy_protocol_version; "3" ]
      );
