...
def verify_release(
    ...
    verify_archive(
        ...
        (
            ...
            "share/trading_engine/contracts/v1/scenario.schema.json",
            "share/trading_engine/contracts/v1/fixtures/demo.scenario.json",
            "share/trading_engine/contracts/cli/v1/result.schema.json",
