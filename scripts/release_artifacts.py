...
def verify_release(
    ...
    verify_archive(
        ...
        (
            ...
            "share/trading_engine/contracts/v7/scenario.schema.json",
            "share/trading_engine/contracts/v7/fixtures/demo.scenario.json",
    ...
    verify_archive(
        ...
        (
            ...
            "contracts/v7/fixtures/demo.scenario.json",
    ...
    verify_archive(
        ...
        (
            ...
            "contracts/v1/scenario.schema.json",
            "contracts/v7/fixtures/demo.scenario.json",
            "contracts/strategy/v5/message.schema.json",
        ),
        epoch,
    )
    verify_archive(
        ...
        (
            ...
            "contracts/v7/scenario.schema.json",
