...
def verify_release(
    ...
    verify_archive(
        ...
        (
            ...
            "share/trading_engine/contracts/v12/scenario.schema.json",
            "share/trading_engine/contracts/v12/fixtures/demo.scenario.json",
    ...
    verify_archive(
        ...
        (
            ...
            "contracts/v12/fixtures/demo.scenario.json",
    ...
    verify_archive(
        ...
        (
            ...
            "contracts/v1/scenario.schema.json",
            "contracts/v12/fixtures/demo.scenario.json",
            "contracts/strategy/v10/message.schema.json",
        ),
        epoch,
    )
    verify_archive(
        ...
        (
            ...
            "contracts/v12/scenario.schema.json",
