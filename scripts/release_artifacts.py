...
def verify_release(
    ...
    verify_archive(
        ...
        (
            ...
            "share/trading_engine/contracts/v6/scenario.schema.json",
            "share/trading_engine/contracts/v6/fixtures/demo.scenario.json",
    ...
    verify_archive(
        ...
        (
            ...
            "contracts/v6/fixtures/demo.scenario.json",
    ...
    verify_archive(
        ...
        (
            ...
            "contracts/v1/scenario.schema.json",
            "contracts/v6/fixtures/demo.scenario.json",
            "contracts/strategy/v4/message.schema.json",
        ),
        epoch,
    )
    verify_archive(
        ...
        (
            ...
            "contracts/v6/scenario.schema.json",
