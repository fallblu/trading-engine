...
def verify_release(
    ...
    verify_archive(
        ...
        (
            ...
            "share/trading_engine/contracts/v13/scenario.schema.json",
            "share/trading_engine/contracts/v13/fixtures/demo.scenario.json",
    ...
    verify_archive(
        ...
        (
            ...
            "contracts/v13/fixtures/demo.scenario.json",
    ...
    verify_archive(
        ...
        (
            ...
            "contracts/v1/scenario.schema.json",
            "contracts/v13/fixtures/demo.scenario.json",
            "contracts/strategy/v11/message.schema.json",
        ),
        epoch,
    )
    verify_archive(
        ...
        (
            ...
            "contracts/v13/scenario.schema.json",
