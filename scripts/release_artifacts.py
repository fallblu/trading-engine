...
def verify_release(
    ...
    verify_archive(
        ...
        (
            ...
            "share/trading_engine/contracts/v4/scenario.schema.json",
            "share/trading_engine/contracts/v4/fixtures/demo.scenario.json",
