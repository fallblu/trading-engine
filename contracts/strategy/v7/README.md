# External strategy protocol v7

Version 7 is a synchronous JSON Lines protocol over child-process standard input and output.
...
Protocol v6 remains available for scenario contract v8; earlier versions retain their frozen
shapes.

Every message repeats `strategy_protocol_version: "7"` and a positive canonical
...
The `initialize` request identifies scenario contract v9 and includes the exact `initial_portfolio`
...
intents use the scenario v9 intent shapes.
