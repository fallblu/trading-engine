# External strategy protocol v11

Version 11 is a synchronous JSON Lines protocol over child-process standard input and output.
...
Protocol v10 remains available for scenario contract v12; earlier versions retain their frozen
shapes.

Every message repeats `strategy_protocol_version: "11"` and a positive canonical
...
The `initialize` request identifies scenario contract v13 and includes the exact `initial_portfolio`
...
intents use the scenario v13 intent shapes. Market-slice events include lifecycle transitions and
