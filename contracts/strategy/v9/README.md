# External strategy protocol v9

Version 9 is a synchronous JSON Lines protocol over child-process standard input and output.
...
Protocol v8 remains available for scenario contract v10; earlier versions retain their frozen
shapes.

Every message repeats `strategy_protocol_version: "9"` and a positive canonical
...
The `initialize` request identifies scenario contract v11 and includes the exact `initial_portfolio`
...
intents use the scenario v11 intent shapes, including recall-origin order snapshots.
