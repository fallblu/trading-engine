# Trading Engine contract v14

This directory is the authoritative v14 process and file contract shared by Trading Engine and its
clients. Versions 13 through 3 remain readable during their client transitions.
...
leverage, and initial-margin limits. Signed cash is valid. A successful v14 run emits `initial_state`
...
Every v14 scenario, stream record, and journal record carries `"contract_version": "14"`.
