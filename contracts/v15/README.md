# Trading Engine contract v15

This directory is the authoritative v15 process and file contract shared by Trading Engine and its
...
leverage, and initial-margin limits. Signed cash is valid. A successful v15 run emits `initial_state`
...
Every v15 scenario, stream record, and journal record carries `"contract_version": "15"`.
...
Version 15 adds `order_book_v1` and bounded level-two `order_book_events`. Every per-instrument
