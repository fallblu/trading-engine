# Trading Engine contract v12

This directory is the authoritative v12 process and file contract shared by Trading Engine and its
clients. Versions 11 through 3 remain readable during their client transitions.
...
leverage, and initial-margin limits. Signed cash is valid. A successful v12 run emits `initial_state`
...
Every v12 scenario, stream record, and journal record carries `"contract_version": "12"`.
