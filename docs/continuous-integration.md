...
contract.
The full test suite additionally validates and replays the current v11 batch, stream, journal, and
strategy-v8 fixtures, including financing attribution and the reconciled first valuation.
