...
Contract v6 advertises and accepts `completed_bar_v1`; embedders can inject another module through
...
Each compiled model owns a strict configuration contract. The v6 envelope separates selection from
